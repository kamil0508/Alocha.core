        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateHappening = table.Column<DateTime>(nullable: false),
                    DateBorn = table.Column<DateTime>(nullable: false),
                    DateInsimination = table.Column<DateTime>(nullable: false),
                    DateDetachment = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SmalPigsId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BornDate = table.Column<DateTime>(nullable: false),
                    PigsQuantity = table.Column<int>(nullable: false),
                    SowId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmallPig", x => x.SmalPigsId);
                    table.ForeignKey(
                        name: "FK_SmallPig_Sow_SowId",
                        column: x => x.SowId,
                        principalTable: "Sow",
